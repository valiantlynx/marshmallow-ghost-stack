...
void DrawTitleScreen(void)
{
    ...
    DrawText("(c) Developed by Gormery K. Wanjiru (@valiantlynx)", 20, GetScreenHeight() - 40, 20, LIGHTGRAY);

    if ((framesCounter > 180) && ((framesCounter/40)%2)) DrawTextEx(font, "PRESS ENTER to START ROASTING", (Vector2){ 230, 450 }, font.baseSize, -2, WHITE);
}
